...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File your_file_name = File.createTempFile("your_file_name", null, new File(
                    "/Users/petr/Desktop/tempfile"));
            ...
            boolean nameHash = somePerson.hashCode() == ivanov.hashCode();
            boolean nameEquals = somePerson.equals(ivanov);
